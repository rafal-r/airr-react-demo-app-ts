...
import { Scene, View, SceneProps, ViewsArray } from "airr-react";
import "../css/Tabs.css";
...
export default class Standard extends Scene {
    ...
    renderTabsMenu = (views: ViewsArray, activeTab: string) => {
        return (
    ...
    handleNavItemClick = (e: SyntheticEvent<HTMLElement>) => {
        const viewName = e.currentTarget.dataset.view as string;
        this.setState(
            {
                children: this.renderTabsMenu(
                    this.state.views as ViewsArray,
                    viewName
                )
            },
            () => {
